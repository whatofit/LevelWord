package com.annotationdao.impl;
...
import com.annotationdao.NotFoundAnnotationException;
import com.annotationdao.annotation.Column;
import com.annotationdao.annotation.Entity;
import com.annotationdao.annotation.Id;
import com.annotationdao.dao.IGenericDao;
import com.annotationdao.dbc.JdbcDaoHelper;
...
public class GenericDaoImpl<T> implements IGenericDao<T> {
    ...
    public int create(T t) throws Exception {
        ...
        sql.append("create table if not exists ").append(tableName)
                .append(" (").append(fieldNames.toString()).append(") ");
        PreparedStatement ps = JdbcDaoHelper.getConnection().prepareStatement(
                sql.toString());
        // 执行SQL
        ps.execute();
